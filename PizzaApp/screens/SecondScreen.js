                    ...
                    <View style={{ flexDirection: 'row', marginTop: responsiveHeight(1) }}>
                        <TouchableOpacity>
                            <LinearGradient style={styles.linearButton} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#de2424', '#c1511d', '#e47b56']}>
                                <View>
                                    <Text style={{ fontSize: responsiveFontSize(2.5), color: '#fff' }}>Small</Text>
                                </View>
                            </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <LinearGradient style={styles.linearButton} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#de2424', '#c1511d', '#e47b56']}>
                                <View>
                                    <Text style={{ fontSize: responsiveFontSize(2.5), color: '#fff' }}>Medium</Text>
                                </View>
                            </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => navigation.navigate('ThirdScreen')}>
                            <LinearGradient style={styles.linearButton} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} colors={['#de2424', '#c1511d', '#e47b56']}>
                                <View>
                                    <Text style={{ fontSize: responsiveFontSize(2.5), color: '#fff' }}>Large</Text>
                                </View>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
